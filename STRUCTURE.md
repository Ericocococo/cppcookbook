...
│   ├── 05_wasm/                                # C++ → WebAssembly（Emscripten/bindgen）
...
│   └── 07_wasm_app/                            # ★新增: WebAssembly 应用（Emscripten + DOM/WebGL）
│                                           #   其他领域来了就追加 08_ 09_ …
│
...
| `09_domain` | 无限增长 | 领域应用：游戏/图形/AI推理/音视频/量化/机器人/Wasm |
